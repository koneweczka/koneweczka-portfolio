...
export function SkillBox({ title, children }: SkillBoxProps) {
  return (
    <div
      role="group"
      aria-label={title}
      className="rounded-2xl border-2 border-brand-turquoise dark:border-brand-turquoise-dark bg-surface-column dark:bg-surface-column-dark shadow-md pt-2 pb-4 px-2 md:pb-6 md:px-3 mb-4"
    >
