...
export function SkillBox({ title, children }: SkillBoxProps) {
  return (
    <div className="rounded-2xl border-2 border-text-section-header dark:border-border-dark bg-bg-box-project dark:bg-bg-box-project-dark shadow-md pt-2 pb-4 px-2 md:pb-6 md-px-3 mb-4">
